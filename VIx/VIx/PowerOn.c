...
#define  HOSTNAME "http://192.168.13.1:80"
#define  HOSTPORT 0
#define  USERNAME "elvan"
#define  PASSWORD "elvan"

#define  VMPOWEROPTIONS   VIX_VMPOWEROP_LAUNCH_GUI   // Launches the VMware Workstaion UI
// when powering on the virtual machine.

#define VMXPATH_INFO "C:/Users/User/Documents/Virtual Machines/proyek/proyek.vmx"
...
int main(int argc, char **argv)
{
	...
	if (strcmp(vmxArg, "LCLONE") == 0) {
		...
		jobHandle = VixVM_Clone(vmHandle,
			...
			vmxClonePath,  // destConfigPathName
			0,  //options,
			VIX_INVALID_HANDLE,  // propertyListHandle
			NULL,  // callbackProc
			NULL);  // clientData
